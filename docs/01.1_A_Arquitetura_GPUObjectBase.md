...
4.  **A Família Assíncrona (Agressiva)**
    *   `GPUCommandEncoder` / Pass Encoders: Passivos e temporários, gravam fita de VHS do que a GPU tem que fazer logo antes do `submit()`.
