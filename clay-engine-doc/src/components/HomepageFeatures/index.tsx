...
const QUICK_LINKS: QuickLink[] = [
    {
        icon: '🚀',
        label: 'Application',
        sub: 'Ponto de entrada da Camada 4',
        to: '/docs/api/presentation/classes/Application',
    },
    {
        icon: '🧱',
        label: 'RigidBody',
        sub: 'Corpos físicos (C3)',
        to: '/docs/api/elements/classes/RigidBody',
    },
    {
        icon: '🔌',
        label: 'Interfaces',
        sub: 'Contratos públicos',
        to: '/docs/api/presentation/interfaces/ApplicationOptions',
    },
    {
        icon: '📦',
        label: 'Módulos',
            ...
            <section className={styles.section}>
                <div className="container">
                    ...
                    <p className={styles.sectionSubtitle}>
                        Motor 3D WebGPU em TypeScript com física, rendering e partículas em tempo
                        real
                    </p>
