...
![Hierarquia GPUObjectBase](/img/guides/schematic_api_hierarchy_1773061766407.png)
...
classDiagram
    ...
    class GPUSampler {
        +magFilter minFilter GPUFilterMode
        +addressModeU V W
    }
    ...
    GPUObjectBase <|-- GPUBuffer
    GPUObjectBase <|-- GPUTexture
    GPUObjectBase <|-- GPUSampler
    GPUObjectBase <|-- GPUBindGroupLayout
    GPUObjectBase <|-- GPUBindGroup
    GPUObjectBase <|-- GPURenderPipeline
    GPUObjectBase <|-- GPUComputePipeline
    GPUObjectBase <|-- GPUShaderModule
    GPUObjectBase <|-- GPUCommandEncoder
    GPUObjectBase <|-- GPURenderBundle

    GPUTexture --> GPUTextureView : createView()
    GPUBindGroupLayout --> GPUBindGroup : template for
    GPUShaderModule --> GPURenderPipeline : vertex+fragment
    GPUShaderModule --> GPUComputePipeline : compute
    GPUBindGroup --> GPURenderPipeline : used by
```
