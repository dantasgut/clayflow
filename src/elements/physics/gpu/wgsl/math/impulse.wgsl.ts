/**
 * Módulo WGSL: impulso de contato e fricção.
 *
 * Funções extraídas de ContactImpulseKernel.ts, compartilhadas entre
 * resolução de colisão RigidBody e resposta de contato de partícula.
 *
 * Depende de: nenhum outro módulo.
 */
export const WGSL_IMPULSE = /* wgsl */`
